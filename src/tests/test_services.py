...
class TestDigitransitAPIService(unittest.TestCase):
    ...
    def setUp(self):
        self.digitransitAPIService = services_stub.DigitransitAPIServiceStub(db.Database())
    ...
    def test_get_stops_by_trip_id(self):
        stoptimes = self.digitransitAPIService.get_stops_by_trip_id('HSL:3001K_20161003_Ma_1_1156', 'V0811')
